...
//    private EmailDetails emailDetails;
    ...
    private static final String FILE = "D:\\Documents\\IndianBankStatement.pdf";

    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        LocalDate start = LocalDate.parse(startDate, DateTimeFormatter.ISO_DATE);
        LocalDate end = LocalDate.parse(endDate, DateTimeFormatter.ISO_DATE);
        List<Transaction> transactionList =
                transactionRepository.findAll().stream().filter(transaction -> transaction.getAccountNumber().equals(accountNumber))
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Indian Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bandAddress = new PdfPCell(new Phrase("123, Some address, New Delhi"));
        bandAddress.setBorder(0);
        bankInfoTable.addCell(bankName);
        bankInfoTable.addCell(bandAddress);
